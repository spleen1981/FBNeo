...
typedef unsigned char (*i8039ReadIoHandler)(unsigned int a);
typedef void (*i8039WriteIoHandler)(unsigned int a, unsigned char v);
typedef unsigned char (*i8039ReadProgHandler)(unsigned int a);
typedef void (*i8039WriteProgHandler)(unsigned int a, unsigned char v);
typedef unsigned char (*i8039ReadOpHandler)(unsigned int a);
typedef unsigned char (*i8039ReadOpArgHandler)(unsigned int a);
