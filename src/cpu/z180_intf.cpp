...
typedef UINT8 (*read_cb)(UINT32 address);
typedef void (*write_cb)(UINT32 address, UINT8 data);
...
void Z180SetWriteHandler(void (*write)(UINT32, UINT8))
{
	prog_write[nActiveCPU] = write;
}

void Z180SetReadHandler(UINT8 (*read)(UINT32))
{
	prog_read[nActiveCPU] = read;
}

void Z180SetFetchOpHandler(UINT8 (*fetch)(UINT32))
{
	prog_fetchop[nActiveCPU] = fetch;
}

void Z180SetFetchArgHandler(UINT8 (*fetch)(UINT32))
{
	prog_fetcharg[nActiveCPU] = fetch;
}

void Z180SetWritePortHandler(void (*write)(UINT32, UINT8))
{
	port_write[nActiveCPU] = write;
}

void Z180SetReadPortHandler(UINT8 (*read)(UINT32))
{
