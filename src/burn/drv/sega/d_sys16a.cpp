...
static struct BurnInputInfo QuartetInputList[] = {
	...
	{"P2 Coin"           , BIT_DIGITAL  , System16InputPort1 + 6, "p2 coin"   },
	...
	{"P3 Coin"           , BIT_DIGITAL  , System16InputPort2 + 6, "p3 coin"   },
	{"P3 Up"             , BIT_DIGITAL  , System16InputPort2 + 1, "p3 up"     },
	{"P3 Down"           , BIT_DIGITAL  , System16InputPort2 + 0, "p3 down"   },
	{"P3 Left"           , BIT_DIGITAL  , System16InputPort2 + 3, "p3 left"   },
	{"P3 Right"          , BIT_DIGITAL  , System16InputPort2 + 2, "p3 right"  },
	{"P3 Fire 1"         , BIT_DIGITAL  , System16InputPort2 + 4, "p3 fire 1" },
	{"P3 Fire 2"         , BIT_DIGITAL  , System16InputPort2 + 5, "p3 fire 2" },

	{"P4 Coin"           , BIT_DIGITAL  , System16InputPort3 + 6, "p4 coin"   },
	{"P4 Up"             , BIT_DIGITAL  , System16InputPort3 + 1, "p4 up"     },
	{"P4 Down"           , BIT_DIGITAL  , System16InputPort3 + 0, "p4 down"   },
	{"P4 Left"           , BIT_DIGITAL  , System16InputPort3 + 3, "p4 left"   },
	{"P4 Right"          , BIT_DIGITAL  , System16InputPort3 + 2, "p4 right"  },
	{"P4 Fire 1"         , BIT_DIGITAL  , System16InputPort3 + 4, "p4 fire 1" },
	{"P4 Fire 2"         , BIT_DIGITAL  , System16InputPort3 + 5, "p4 fire 2" },
...
static struct BurnDIPInfo Passsht16aDIPList[]=
{
	...
	{0x01, 0x01, 0x0e, 0x06, "2000"                               },
	{0x01, 0x01, 0x0e, 0x0a, "3000"                               },
	{0x01, 0x01, 0x0e, 0x0c, "4000"                               },
	{0x01, 0x01, 0x0e, 0x0e, "5000"                               },
	{0x01, 0x01, 0x0e, 0x08, "6000"                               },
	{0x01, 0x01, 0x0e, 0x04, "7000"                               },
	{0x01, 0x01, 0x0e, 0x02, "8000"                               },
	{0x01, 0x01, 0x0e, 0x00, "9000"                               },
...
static struct BurnRomInfo Aliensyn2RomDesc[] = {
	{ "epr-10808.b9",  0x08000, 0xe669929f, SYS16_ROM_PROG | BRF_ESS | BRF_PRG },
	{ "epr-10806.b6",  0x08000, 0x9f7f8fdd, SYS16_ROM_PROG | BRF_ESS | BRF_PRG },
	{ "epr-10809.b10", 0x08000, 0x9a424919, SYS16_ROM_PROG | BRF_ESS | BRF_PRG },
	{ "epr-10807.b7",  0x08000, 0x3d2c3530, SYS16_ROM_PROG | BRF_ESS | BRF_PRG },
	{ "epr-10701.b11", 0x08000, 0x92171751, SYS16_ROM_PROG | BRF_ESS | BRF_PRG },
	{ "epr-10698.b8",  0x08000, 0xc1e4fdc0, SYS16_ROM_PROG | BRF_ESS | BRF_PRG },

	{ "epr-10739.c9",  0x10000, 0xa29ec207, SYS16_ROM_TILES | BRF_GRA },
	{ "epr-10740.c10", 0x10000, 0x47f93015, SYS16_ROM_TILES | BRF_GRA },
	{ "epr-10741.c11", 0x10000, 0x4970739c, SYS16_ROM_TILES | BRF_GRA },

	{ "epr-10709.c5",  0x10000, 0xaddf0a90, SYS16_ROM_SPRITES | BRF_GRA },
	{ "epr-10713.b2",  0x10000, 0xececde3a, SYS16_ROM_SPRITES | BRF_GRA },
	{ "epr-10710.c6",  0x10000, 0x992369eb, SYS16_ROM_SPRITES | BRF_GRA },
	{ "epr-10714.b3",  0x10000, 0x91bf42fb, SYS16_ROM_SPRITES | BRF_GRA },
	{ "epr-10711.c7",  0x10000, 0x29166ef6, SYS16_ROM_SPRITES | BRF_GRA },
	{ "epr-10715.b4",  0x10000, 0xa7c57384, SYS16_ROM_SPRITES | BRF_GRA },
	{ "epr-10712.c8",  0x10000, 0x876ad019, SYS16_ROM_SPRITES | BRF_GRA },
	{ "epr-10716.b5",  0x10000, 0x40ba1d48, SYS16_ROM_SPRITES | BRF_GRA },

	{ "epr-10705.b1",  0x08000, 0x777b749e, SYS16_ROM_Z80PROG | BRF_ESS |BRF_PRG },

	{ "7751.bin",      0x00400, 0x6a9534fc, SYS16_ROM_7751PROG | BRF_ESS | BRF_PRG },

	{ "epr-10706.c1",  0x08000, 0xaa114acc, SYS16_ROM_7751DATA | BRF_SND },
...
static void Passsht16aMakeAnalogInputs()
{
...
static INT32 Passsht16aInit()
{
	...
	System16MakeAnalogInputsDo = Passsht16aMakeAnalogInputs;
...
struct BurnDriver BurnDrvAceattaca = {
	"aceattaca", "aceattac", NULL, NULL, "1988",
...
struct BurnDriver BurnDrvAFighter = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1089A_ENC, GBF_VERSHOOT, 0,
...
struct BurnDriver BurnDrvAFightera = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A, GBF_VERSHOOT, 0,
...
struct BurnDriver BurnDrvAFighterc = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1089B_ENC, GBF_VERSHOOT, 0,
...
struct BurnDriver BurnDrvAlexkidd1 = {
	...
	"Alex Kidd: The Lost Stars (set 1, FD1089A 317-0021)\0", NULL, "Sega", "System 16A",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1089A_ENC, GBF_PLATFORM, 0,
...
struct BurnDriver BurnDrvBodyslam = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A, GBF_VSFIGHT, 0,
...
struct BurnDriver BurnDrvDumpmtmt = {
	...
	"Dump Matsumoto (Japan, 8751 317-0011a)\0", NULL, "Sega", "System 16A",
	 L"Dump Matsumoto (Japan, 8751 317-unknown)\0\u30C0\u30F3\u30D7\u677E\u672C\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A, GBF_VSFIGHT, 0,
...
struct BurnDriver BurnDrvFantzone = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A, GBF_HORSHOOT, 0,
...
struct BurnDriver BurnDrvFantzonee = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1089B_ENC, GBF_HORSHOOT, 0,
...
struct BurnDriver BurnDrvFantzonepr = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A, GBF_HORSHOOT, 0,
...
struct BurnDriver BurnDrvMjleague = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A, GBF_SPORTSMISC, 0,
...
struct BurnDriver BurnDrvPasssht16a = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 4, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1094_ENC, GBF_SPORTSMISC, 0,
...
struct BurnDriver BurnDrvQuartet = {
	...
	"Quartet (Rev A, 8751 315-5194)\0", NULL, "Sega", "System 16A",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_SEGA_SYSTEM16A, GBF_PLATFORM, 0,
...
struct BurnDriver BurnDrvQuarteta = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_SEGA_SYSTEM16A, GBF_PLATFORM, 0,
...
struct BurnDriver BurnDrvQuartet2 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A, GBF_PLATFORM, 0,
...
struct BurnDriver BurnDrvSdi = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1089B_ENC, GBF_SHOOT, 0,
...
struct BurnDriver BurnDrvTetris = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1094_ENC, GBF_PUZZLE, 0,
...
struct BurnDriver BurnDrvTetrisd = {
	...
	"Tetris (set 4, Japan, System 16A) (bootleg of FD1094 317-0093 set)\0", NULL, "bootleg", "System 16A",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvTetris3 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_SEGA_SYSTEM16A | HARDWARE_SEGA_FD1094_ENC, GBF_PUZZLE, 0,
...
struct BurnDriver BurnDrvTetris3d = {
	...
	"Tetris (set 3, Japan, System 16A) (bootleg of FD1094 317-0093a set)\0", NULL, "bootleg", "System 16A",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_SEGA_SYSTEM16A, GBF_PUZZLE, 0,
...
struct BurnDriver BurnDrvWb31d = {
	...
	"Wonder Boy III - Monster Lair (set 1, Japan, System 16A) (bootleg of FD1094 317-0084 set)\0", NULL, "bootleg", "System 16A",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvWb35d = {
	...
	"Wonder Boy III - Monster Lair (set 5, Japan, System 16A) (bootleg of FD1089A 317-0086 set)\0", NULL, "bootleg", "System 16A",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_SEGA_SYSTEM16A, GBF_PLATFORM, 0,
